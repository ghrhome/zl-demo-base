...
var pageView=(function($){
    ...
    pageView.eventInit=function(){
        ...
        //发起审批
        $("#js-submit1").on("click",function(e){
            e.preventDefault();
            //$(".zl-loading").fadeIn();
            ...
            if (billId == null || billId == "") {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    type: "POST",
                    url: netcommentWeb_Path + "netcomment/contractSup/submitNetComment.htm",
                    data: {billId:billId},
                    ...
                    success: function (resultData) {
                        if (resultData.success) {
                            formPost(netcommentWeb_Path + "/netcomment/contractSup/list.htm", {billType:"03"});
                        } else {
                            alert("发起审批失败!");
                            $(".zl-loading").fadeOut();  // 隐藏 loading
                        }

    ...
    pageView.pageInit=function(){
        ...
        $("tbody tr").on("click", function(){
            ...
            if(billStatus == "01" || billStatus == "05" || billStatus == "07"){
                formPost("toEditView.htm", {masterId:$(this).attr("dataId"), billType: 10});
            } else {
                formPost("toBillDetail.htm", {masterId:$(this).attr("dataId"), billType: 10});
            }
        });

        //新增
        $("#addButton").on("click", function(){
            formPost("toEditView.htm", {billType: 10});
        });

$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let heaArr=[ "MALL_NAME", "COMPANY_NAME", "BRAND_NAME", "CONT_NO", "CONT_TYPE", "CHARGE_ITEM_NAME", "RECE_EXPENSE_VERIFICATION_NO", "RECE_NO", "CAIWU_MONTH", "BUSINESS_PERIOD", "RECEIVE_TIME", "VERIFICATION_TIME", "UPDATED_DATE", "VERIFICATION_STATUS", "CHARGE_PERIOD", "NEW_DE_AMOUNT", "KEEP_OFFSET_AMOUNT", "RE_OFFSET_AMOUNT", "LATE_FEE_AMOUNT", "RECEIVED_LATE_FEE"];
        // let Arr = ["NEW_DE_AMOUNT", "KEEP_OFFSET_AMOUNT", "RE_OFFSET_AMOUNT", "LATE_FEE_AMOUNT", "RECEIVED_LATE_FEE"];
        ...
        pageView.init = function (param) {
            // 核销月
            $('input[name=verificationTime]').val(pageView.theMonth());
            Api.locaShow();
            Api.init('/report_web/invoice_details_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/invoice_details_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/invoice_details_report/export.htm", pageView.reportData());
        });

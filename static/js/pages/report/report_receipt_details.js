$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let heaArr = ["brandName", "contNo", "receiptNo", "mallName", "blockName", "floorName", "_storeNo", "companyCode", "companyName", "_contType", "paymentName", "_receipts", "statusName", "receiptDate", "operator", "_billNumber", "_billingTime", "receType", "feeType", "businessPeriod", "caiwuMonth", "_itemAmount", "_invalidNumber", "_invalidTime", "_note"];
        ...
        pageView.init = function (param) {
            ...
            Api.locaShow();
            Api.init('/report_web/receipt_details_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
            pageView.dropDown();
            pageView.reportAjax();
            pageView.paging();
            // pageView.locaHide();
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/receipt_details_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/receipt_details_report/export.htm", pageView.reportData());
        });

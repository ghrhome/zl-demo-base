$(function (param) {
    let pageView = (function (param) {
        ...
        pageView.init = function (param) {
            $('input[name=chargeYM]').val(pageView.lastMonth());
            Api.locaShow();
            Api.init('/report_web/property_hydropower_input_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/property_hydropower_input_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/property_hydropower_input_report/export.htm", pageView.reportData());
        });

$(function (param) {
    let pageView = (function (param) {
        ...
        pageView.ajax=function() {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '/report_web/fin_invoice_report/getReportData.htm',
                    type: 'POST',
        ...
        pageView.handsontable=function(resoult){
            ...
            var hotSettings = {
                ...
                columns: [
                    ...
                    {data: "blockName", type: 'text',readOnly: true},
                    {data: "floorName", type: 'text',readOnly: true},
                    {data: "storeNo", type: 'text',readOnly: true},
                    ...
                    {data: "payeeName", type: 'text',readOnly: true},
                    {data: "sourceName", type: 'text',readOnly: true},
                    {data: "centReceTypeName", type: 'text',readOnly: true},
                    {data: "invoiceTypeName", type: 'text',readOnly: true},
                    {data: "statusName", type: 'text',readOnly: true},
                    {data: "invoiceNo", type: 'text',readOnly: true},
                    {data: "invoiceCode", type: 'text',readOnly: true},
                    {data: "invoiceDate", type: 'text',readOnly: true},
                    {data: "billNo", type: 'text',readOnly: true},
                    {data: "businessPeriod", type: 'text',readOnly: true},
                    {data: "financePeriod", type: 'text',readOnly: true},
                    {data: "amount", type: 'text',readOnly: true},
                    {data: "noTaxAmount", type: 'text',readOnly: true},
                    {data: "taxAmount", type: 'text',readOnly: true},
                    {data: "receAmount", type: 'text',readOnly: true},
                    {data: "subedAmount", type: 'text',readOnly: true},
                    {data: "invoiceAmount", type: 'text',readOnly: true},
                    {data: "invoicer", type: 'text',readOnly: true},
                    {data: "reviewer", type: 'text',readOnly: true},
                    {data: "receiver", type: 'text',readOnly: true},
                    {data: "redInvoiceNo", type: 'text',readOnly: true},
                    {data: "redInvoiceCode", type: 'text',readOnly: true},
                    {data: "redInvoiceDate", type: 'text',readOnly: true}
                ],
        ...
        pageView.init = function (param) {
            ...
            //    财务月
            $('input[name=businessPeriod]').val(result);
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/fin_invoice_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/fin_invoice_report/export.htm", pageView.reportData());
        });

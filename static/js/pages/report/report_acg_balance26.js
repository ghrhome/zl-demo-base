$(function (param) {
    let pageView = (function (param) {
        ...
        let pageView = {};
        let dataView = ["rowNum", "FLASHDATE", "DATAYYYYMM", "MALL_NAME", "CONT_NO", "STORE_NOS", "COMPANY_NAME", "BRAND_NAME", "SUM0_30", "SUM31_60", "SUM61_90", "SUM91_120", "SUM121_365", "SUM366_1095", "SUM1096", "SUM_ALL", "KEEP_REST", "KEEP_SUBS_BALANCE"];
        // 判断元素类型
        // 获取数据
        // 传入jq元素
        ...
        pageView.ajax = function (param) {
            ...
            $.ajax({
                url: '/report_web/acg_balance/getReportDate.htm',
                type: 'POST',
        ...
        pageView.init = function (param) {
            ...
            pageView.mhss($('#storeNosDiv'), '/report_web/baseInfo/getStoreNos.htm', $('#storeNos').val(), 'STORE_NO', $('#storeNosInput'))
            pageView.locaShow();
            pageView.ajax();
            pageView.dropDown();
            pageView.reportAjax();
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/acg_balance/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/acg_balance/export.htm", pageView.reportData());
        });

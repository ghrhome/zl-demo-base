$(function (param) {
    let pageView = (function (param) {
        ...
        let heaArr=[  "ITEM_NAME", "RECEIVED_NO", "CONT_NO", "COMPANY_NAME", "ACCOUNT_NAME", "PAYMENT_TERM_NAME", "FIN_YM", "REMARK", "RECEIVE_DATE", "SOURCE_TYPE", "CREATED_DATE", "ADVANCE_RENT", "ADVANCE_ELECTRICITY", "ADVANCE_SERVICE"];
        let Api=new ReportApi($('#hot')[0],heaArr,2);
        // 判断元素类型
        // 获取数据
        // 传入jq元素
        ...
        pageView.init = function (param) {
            ...
            Api.locaShow();
            Api.init('/report_web/booking_details_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/booking_details_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/booking_details_report/export.htm", pageView.reportData());
        });

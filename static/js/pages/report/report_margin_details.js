$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let heaArr=["brandName", "contNo", "chargeItemName", "mallName", "blockName", "floorName", "storeNo", "companyCode", "companyName", "contType", "centReceType", "payeeName", "businessPeriod", "caiwuMonth", "receAmount", "subAmount", "deAmount", "arrearageAmount", "yieldRate", "restKeep", "keepBackUp", "keepPay", "keepPunishment"];
        ...
        pageView.init = function (param) {
            ...
            Api.locaShow();
            Api.init('/report_web/margin_details_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/margin_details_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/margin_details_report/export.htm", pageView.reportData());
        });

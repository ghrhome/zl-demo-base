$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        // let Arr = ["CONTRACT_PRICE", "RATE", "LAST_COUNT"];
        let heaArr=[  "MALL_NAME", "HYD_CODE", "DEVICE_CODE", "DEVICE_NAME", "DEVICE_STATUS", "HYD_TYPE", "CONTRACT_PRICE", "CONT_NO", "CONT_STATUS", "COMPANY_NAME", "BRAND_NAME", "STORE_TYPE", "STORE_NO", "INIT_READING_DATE", "TRANSPORTATION_TYPE", "PAYMENT_METHOD", "RATE", "LAST_COUNT"];
        ...
        pageView.init = function (param) {
            Api.locaShow();
            Api.init('/report_web/property_energy_equipment_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/property_energy_equipment_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/property_energy_equipment_report/export.htm", pageView.reportData());
        });

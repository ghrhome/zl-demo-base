$(function (param) {
    let pageView = (function (param) {
        ...
        let heaArr=["ITEM_NAME", "CONT_NO", "COMPANY_NAME", "ACCOUNT_NAME", "ADVANCE_RENT", "ADVANCE_ELECTRICITY", "ADVANCE_SERVICE"];
        ...
        pageView.init = function (param) {
            ...
            Api.locaShow();
            Api.init('/report_web/deposit_balance_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/deposit_balance_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/deposit_balance_report/export.htm", pageView.reportData());
        });

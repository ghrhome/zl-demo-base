$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let heaArr=["ITEM_NAME", "RECE_EXPENSE_VERIFICATION_NO", "BUSINESS_PERIOD", "CONT_NO", "BRAND_NAME", "COMPANY_NAME", "CHARGE_ITEM_NAME", "VERIFICATION_TIME", "NEW_DE_AMOUNT", "KEEP_OFFSET_AMOUNT", "RE_OFFSET_AMOUNT", "LATE_FEE_AMOUNT", "RECEIVED_LATE_FEE"];
        ...
        pageView.init = function (param) {
            Api.locaShow();
            Api.init('/report_web/new_system_verification_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/new_system_verification_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/new_system_verification_report/export.htm", pageView.reportData());
        });

$(function (param) {
    let pageView = (function (param) {
        ...
        pageView.init = function (param) {
            ...
            Api.locaShow();
            Api.init('/report_web/receivable_received_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/receivable_received_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/receivable_received_report/export.htm", pageView.reportData());
        });

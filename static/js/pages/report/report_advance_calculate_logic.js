$(function (param) {
    let pageView = (function (param) {
        ...
        pageView.ajax=function() {
            new Promise((resolve, reject) => {
                $.ajax({
                    url: '/report_web/advanceCalculateLogic/getReportData.htm',
                    type: 'POST',
                ...
                resoult.data= [{
                    ...
                    "accountName":null,
                    "sumAmount":null,
                    "advanceNewIncrease":null,
                    "receToAdvance":null,
                    "advanceOffsetBond":null,
                    "advanceOffsetFee":null,
                    "advanceReturn":null
                }];
                pageView.handsontable(resoult);
        ...
        pageView.handsontable=function(resoult){
            ...
            var hotSettings = {
                ...
                columns: [
                    ...
                    {data: "sumAmount", type: 'text',readOnly: true},
                    {data: "advanceNewIncrease", type: 'text',readOnly: true},
                    {data: "receToAdvance", type: 'text',readOnly: true},
                    {data: "advanceOffsetBond", type: 'text',readOnly: true},
                    {data: "advanceOffsetFee", type: 'text',readOnly: true},
                    {data: "advanceReturn", type: 'text',readOnly: true}
                ],
                ...
                colHeaders: ["商场名称","合同号","租户名称","收款单位名称","预收款余额","预收款新增","收款结余预收款","预收款冲保证金","预收款冲费用","预收款返还"],// resoult.title
                maxRows: 2000,//最大行数
                // maxCols:20,//最大列数
                // filters: true,//过滤器
                // observeChanges:true,
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/advanceCalculateLogic/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/advanceCalculateLogic/export.htm", pageView.reportData());
        });

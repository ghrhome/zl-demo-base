$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let heaArr=["COMPANY_NAME", "BRAND_NAME", "CHARGE_ITEM_NAME", "ITEM_NAME", "COMPANY_CODE", "CONT_NO", "STORE_NOS", "BUSINESS_PERIOD", "CAIWU_MONTH", "RECEIPT_TYPE", "RECE_NO", "RECE_DATE", "ARREARAGE_AMOUNT", "RECE_AMOUNT", "DE_AMOUNT"];
        // let Arr = ["ARREARAGE_AMOUNT", "RECE_AMOUNT", "DE_AMOUNT"];
        ...
        pageView.init = function (param) {
            Api.locaShow();
            Api.init('/report_web/real_time_arrears_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/real_time_arrears_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/real_time_arrears_report/export.htm", pageView.reportData());
        });

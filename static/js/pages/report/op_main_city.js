var pageView=(function($){
    ...
    pageView.getList = function () {
        ...
        var params = {areaId:$("#areaId").val(),type:1};
        $.ajax({
            cache: true,
            type: "post",
            ...
            success: function (data) {
               ...
               // console.log(data);
                var json=eval('(' +data+ ')');
                $(".availableSquare").html(json.availableSquare+"<em class=\"em-unit\">万m²</em>");
                ...
                // 昨日销售额
                $(".yesterday-sales").html(json.yesterdaySales+'<em class="em-unit">(万元)</em>');

                $(".yesterday-sales-no-anchor").html(json.yesterdaySalesNoAnchor+'<em class="em-unit">(万元)</em>');

$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        // let Arr = ["ARREARAGE_AMOUNT", "RECE_AMOUNT", "SUB_AMOUNT", "DE_AMOUNT"];
        let heaArr=[  "ITEM_NAME", "COMPANY_CODE", "CONT_NO", "COMPANY_NAME", "STORE_NOS", "BRAND_NAME", "CHARGE_ITEM_NAME", "BUSINESS_PERIOD", "CAIWU_MONTH", "RECEIPT_TYPE", "RECE_NO", "RECE_DATE", "ARREARAGE_AMOUNT", "RECE_AMOUNT", "SUB_AMOUNT", "DE_AMOUNT"];
        ...
        pageView.init = function (param) {
            Api.locaShow();
            Api.init('/report_web/tenants_owe_report/getReportData.htm',pageView.reportData(),'reportData','newTitles');
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            ...
            formPost("/report_web/tenants_owe_report/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/tenants_owe_report/export.htm", pageView.reportData());
        });

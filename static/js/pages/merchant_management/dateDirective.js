              ...
              /*  $scope.$watch('startDate',function(){
                ...
                $scope.$watch('endDate',function(){
                    if($scope.endDate) {
                        ...
                        //dpicker.fill();
                        //dpicker.update();
                        $element.find("input.js-date-end").datetimepicker('setStartDate', $scope.startDate);

                        $element.find("input.js-date-end").datetimepicker('setInitialDate', $scope.startDate);

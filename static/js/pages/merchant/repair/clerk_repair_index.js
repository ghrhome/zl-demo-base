var pageView = (function ($) {
    ...
    pageView.init = function () {
        ...
        $("#js-add-new").on("click", function () {
            formPost(merchantWeb_Path + "repair/clerkRepairAdd", "");
        });
    }
    ...
    pageView.initTable = function () {
        ...
        $(".zl-section").on("click", function (e) {
            ...
            if (target.is('td')) {
                ...
                formPost(merchantWeb_Path + "repair/queryClerkRepariDetail", dataQuery);
                pageView.loadingHide();
            }
        });
    }
    ...
    pageView.functionButton = function () {
        ...
        $(".zl-content").on("click", function (e) {
                ...
                if (target.is('a') && target.hasClass('repair_distribution')) {
                    ...
                    e.stopPropagation();
                    formPost(merchantWeb_Path + "repair/clerkRepairFeedback", dataQuery);
                    pageView.loadingHide();
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == "0") {
                    ...
                    formPost(merchantWeb_Path + "repair/clerkRepairInit", dataQuery);
                } else if (msg == "2") {
                    alert("后台异常");
                } else {
                    alert("流程已被处理，请刷新页面!");

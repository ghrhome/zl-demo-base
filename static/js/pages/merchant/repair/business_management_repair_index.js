var pageView = (function ($) {
    ...
    pageView.init = function () {
        ...
        $("#js-add-new").on("click", function () {
            formPost(merchantWeb_Path + "repair/businessManagementRepairAdd", "");
        });
    }
    ...
    pageView.initTable = function () {
        ...
        $(".zl-section").on("click", function (e) {
            ...
            if (target.is('td')) {
                ...
                formPost(merchantWeb_Path + "repair/queryBusinessManagementRepariDetail", dataQuery);
                pageView.loadingHide();
            }
    ...
    pageView.functionButton = function () {
        $(".zl-content").on("click", function (e) {
                ...
                } else if (target.is('a') && target.hasClass('repair_receipt')) {

                }else if (target.is('a') && target.hasClass('repair_feedback')) {
                    e.stopPropagation();
                    formPost(merchantWeb_Path + "repair/businessManagementRepairFeedback", dataQuery);
                    pageView.loadingHide();
...
//分页查询
    pageView.generalQueryBtn = function generalQueryBtn(flag, page) {
        ...
        var url = "queryBusinessManagementRepairList";
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == "0") {
                    ...
                    formPost(merchantWeb_Path + "repair/businessManagementRepairInit", dataQuery);
                } else if (msg == "2") {
                    alert("后台异常");
                } else {
                    alert("流程已被处理，请刷新页面!");

(function ($) {
    ...
    $("#searchType").on("click", function (e) {
        $("#searchReForm").attr("action", managementWeb_Path + "propertyManagerAudit/electric/index.htm").submit();
    });
    /**
     * 下拉初始化
     */
    ...
    $("#searchBsFloorForm").submit(function () {
        ...
        self.attr("action", managementWeb_Path + "propertyManagerAudit/water/index.htm");
    });
    /**
     * 审核
     */
        ...
        if(flag){
            confirm("确认要审核吗？","","",function (type) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: managementWeb_Path + "propertyManagerAudit/water/audit.htm",
        ...
        if(flag){
            confirm("确认要取消审核吗？","","",function (type) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: managementWeb_Path + "propertyManagerAudit/water/cancel.htm",
                    data: {ids : ids.toString()},
                    //async: false,
                    error: function (request) {
                        loadingHide();

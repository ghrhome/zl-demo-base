(function ($) {
    ...
    $("#searchType").on("click", function (e) {
        $("#searchReForm").attr("action", managementWeb_Path + "financialManagerAudit/electric/index.htm").submit();
    });
    /**
     * 下拉初始化
     */
    ...
    $("#searchBsFloorForm").submit(function () {
        ...
        self.attr("action", managementWeb_Path + "financialManagerAudit/water/index.htm");
    });
    /**
     * 审核
     */
    $("#examineButton").on("click",function (e) {
        confirm("确认要审核吗？","","",function (type) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                url: managementWeb_Path + "financialManagerAudit/water/audit.htm",

...
var pageView=(function($){
    ...
    pageView.init=function(){
        ...
        $("#searchType").unbind('click').on("click", function (e) {
            loadingshow();
            location.href=managementWeb_Path + "energyConsumptionRecord/water/index.htm";
        ...
        $("#daoru").unbind('click').click(function () {
            $("<input type='file' name='file' style='display: none'/>").appendTo("body").change(function () {
                ...
                $.ajax({
                    url: managementWeb_Path+'energyConsumptionRecord/electric/upload-excel.htm',
                    type: 'POST',
                    dataType: "json",
                    cache: false,
                    data: formData,
        ...
        $("#saveExcel").unbind('click').on("click", function (e) {
            $.ajax({
                ...
                url: managementWeb_Path+'energyConsumptionRecord/electric/addAllOrUpdateAll.htm',
                type: 'POST',
                dataType: "json",
                cache: false,
        ...
        $("[name=updateBsFloorBtn]").unbind("click").on("click", function () {
            ...
            confirm("确认要提交吗？","","",function (type) {
                ...
                $.ajax({
                    cache: true,
                    type: "POST",
                    url: managementWeb_Path + "energyConsumptionRecord/electric/addOrUpdate.htm",
        ...
        $(".lookLis").on("click", function (e) {
            ...
            window.location.href=managementWeb_Path +"energyConsumptionRecord/electric/rates.htm?mngHydroelectricId=" + mngHydroelectricEntityId;
        });
        //====================================
...
$("#searchBsFloorForm").submit(function () {
    ...
    self.attr("action", managementWeb_Path + "energyConsumptionRecord/electric/index.htm");
});

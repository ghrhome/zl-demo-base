$(function (param) {
    let pageView = (function (param) {
        ...
        let pageView = {};
        let itemsPerPage=10;
        let dataView = ["INDEX_ID", "rowNum", "ITEM_NAME", "COMPANY_CODE", "CONT_NO", "COMPANY_NAME", "STORE_NOS", "BRAND_NAME", "CHARGE_ITEM_NAME", "BUSINESS_PERIOD", "CAIWU_MONTH", "RECEIPT_TYPE", "RECE_NO", "RECE_DATE", "ARREARAGE_AMOUNT", "RECE_AMOUNT", "DE_AMOUNT"];
        // 判断元素类型
        // 获取数据
        // 传入jq元素
        ...
        pageView.ajax = function (param) {
            ...
            $.ajax({
                url: '/report_web/realTimeArrearsReport/getReportDate.htm',
                type: 'POST',
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            formPost("/report_web/realTimeArrearsReport/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/realTimeArrearsReport/export.htm", josn);
        });

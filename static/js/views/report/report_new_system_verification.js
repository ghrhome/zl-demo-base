$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let dataView = ["rowNum", "INDEX_ID", "ITEM_NAME", "RECE_EXPENSE_VERIFICATION_NO", "BUSINESS_PERIOD", "CONT_NO", "BRAND_NAME", "COMPANY_NAME", "CHARGE_ITEM_NAME", "VERIFICATION_TIME", "NEW_DE_AMOUNT", "KEEP_OFFSET_AMOUNT", "RE_OFFSET_AMOUNT", "LATE_FEE_AMOUNT", "RECEIVED_LATE_FEE"];
        // 判断元素类型
        // 获取数据
        // 传入jq元素
        ...
        pageView.ajax = function (param) {
            ...
            $.ajax({
                url: '/report_web/newSystemVerification/getReportDate.htm',
                type: 'POST',
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            formPost("/report_web/newSystemVerification/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/newSystemVerification/export.htm", josn);
        });

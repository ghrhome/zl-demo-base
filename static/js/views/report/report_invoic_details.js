$(function (param) {
    let pageView = (function (param) {
        ...
        pageView.ajax = function (param) {
            ...
            $.ajax({
                url: '/report_web/invoiceDetailsReport/getReportDate.htm',
                type: 'POST',
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            formPost("/report_web/invoiceDetailsReport/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/invoiceDetailsReport/export.htm", josn);
        });

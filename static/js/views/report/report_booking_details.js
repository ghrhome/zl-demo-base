$(function (param) {
    let pageView = (function (param) {
        ...
        let itemsPerPage=10;
        let pageView = {};
        let dataView = ["INDEX_ID", "rowNum", "ITEM_NAME", "RECEIVED_NO", "CONT_NO", "COMPANY_NAME", "ACCOUNT_NAME", "PAYMENT_TERM_NAME", "FIN_YM", "REMARK", "RECEIVE_DATE", "SOURCE_TYPE", "CREATED_DATE", "ADVANCE_RENT", "ADVANCE_SERVICE", "ADVANCE_ELECTRICITY"];
        // 判断元素类型
        // 获取数据
        // 传入jq元素
        ...
        pageView.ajax = function (param) {
            ...
            $.ajax({
                url: '/report_web/bookingDetailsReport/getReportDate.htm',
                type: 'POST',
    ...
    $(document).ready(function (param) {
        ...
        $('#exportAll').click(function () {
            formPost("/report_web/bookingDetailsReport/exportAll.htm", pageView.reportData());
        });
        ...
        $('#export').click(function () {
            ...
            formPost("/report_web/bookingDetailsReport/export.htm", josn);
        });
